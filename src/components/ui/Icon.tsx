...
// AWS wordmark, inlined from the devicons-react source SVG so the site does not
// pay for that package's full icon set: its entry point does an unconditional
// CommonJS require() of every one of its ~3,700 icons, so importing even one
// icon from it pulls the whole set into the client bundle (multiple megabytes)
// since bundlers cannot tree-shake eagerly-required CJS modules.
